...
<body>
    <nav class="navbar">
        <input type="checkbox">
            ...
            <span></span>
            <div class="menu">
                <a href="index.html" class="nav_link_resp">INICIO</a>
                <a href="#Inicio" class="nav_link_resp">INFORMACION DEL JUEGO</a>
                <a href="campeones.html" class="nav_link_resp">CAMPEONES</a>
                <a href="historias.html" class="nav_link_resp">NOTICIAS</a>
                <a href="notasVersion.html" class="nav_link_resp"> NOTAS DE VERSIÓN</a>
                ...
                <div class="nav-links">
                    ...
                    <div class="nav-link">
                        ...
                        <ul class="nav-sublinks">
                            ...
                            <li class="nav-sublink"><a href="historias.html">Historias</a></li>
